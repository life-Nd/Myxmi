...
import 'package:myxmi/providers/app_network.dart';
import 'package:package_info/package_info.dart';

class AboutView extends HookWidget {
  final AppNetworkProvider _appNetwork = AppNetworkProvider();
      ...
      body: Column(
        children: [
          ListTile(
            ...
            onTap: () {
              _appNetwork.launchURL(url: _privacyUrl);
            },
            title: Text(
              'privacy'.tr(),
          ...
          ListTile(
            ...
            onTap: () {
                   _appNetwork.launchURL(url: _termsUrl);
            },
            title: Text(
              'terms'.tr(),
              style: const TextStyle(fontSize: 20),
