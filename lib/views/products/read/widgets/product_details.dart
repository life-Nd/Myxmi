...
class ProductDetails extends StatelessWidget {
                  ...
                  return Row(
                    ...
                    children: [
                      RawMaterialButton(
                        ...
                        onPressed: () {
                          ...
                          changeStock(
                            ...
                            quantity: double.parse(_productLeft) - 1,
                          );
                          stateSetter(() {});
                        },
                        child: const Text(
                            ...
                            child: TextField(
                              ...
                              onEditingComplete: () {
                                ...
                                changeStock(
                                    expiration: product.expiration,
                                    id: product.productId,
                                    quantity: double.parse(_productLeft));
                                _stockCtrl.clear();
                      ...
                      RawMaterialButton(
                        ...
                        onPressed: () async {
                          product.left = '${double.parse(_productLeft) + 1}';
                          changeStock(
                              expiration: product.expiration,
                              id: product.productId,
                              quantity: double.parse(_productLeft) + 1.0);
                          stateSetter(() {});
                        },
                        child: const Text(
                          '+',
  ...
  Future changeStock({double quantity, String expiration, String id}) async {
